...
-- OTHER PRACTICED QUESTIONS

-- Display the names of athletes who won a gold medal in the 2008 Olympics and whose height is greater
-- than the average height of all athletes in the 2008 Olympics.
SELECT Name FROM olympi
WHERE Year= 2008 AND Medal='Gold' AND Height > (SELECT AVG(Height) FROM olympi
													WHERE Year= 2008);
...
SELECT Name FROM olympi
WHERE Sport = 'Basketball'AND Year= 2016 AND Medal IS NOT NULL AND Weight < (SELECT AVG(Weight) FROM olympi
...
SELECT DISTINCT Name FROM olympi
WHERE Medal IS NOT NULL AND Sport = 'Swimming' AND Year= 2016 AND Name IN (SELECT Name FROM olympi
												WHERE Medal IS NOT NULL AND Sport = 'Swimming' AND Year= 2008);
                                                
-- Display the names of all CITY that have won more than 50 medals in a single year.
SELECT City
FROM olympi
